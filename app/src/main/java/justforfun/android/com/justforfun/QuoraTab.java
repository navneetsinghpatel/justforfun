...
public class QuoraTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View V= inflater.inflate(R.layout.quora_tab, container, false);
        webView = (WebView) V.findViewById(R.id.qu);
        // Enable Javascript
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.getSettings().setDomStorageEnabled(true);
        mPbar = (ProgressBar) V.findViewById(R.id.quSpinner);
