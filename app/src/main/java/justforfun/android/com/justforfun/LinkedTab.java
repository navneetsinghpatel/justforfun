...
public class LinkedTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View V= inflater.inflate(R.layout.linked_tab, container, false);
        webView = (WebView) V.findViewById(R.id.li);
        // Enable Javascript
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.getSettings().setDomStorageEnabled(true);
        mPbar = (ProgressBar) V.findViewById(R.id.liSpinner);

        webView.loadUrl("https://m.linkedin.com");
